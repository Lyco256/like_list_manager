...
- 検索/絞り込みの適用、日付条件、投稿者条件とタグ条件の複合E2E、投稿者クリックによる分類済み投稿者フィルター遷移、キャンセル、BackHandler破棄、全クリアとDB fingerprint不変
...
- 保存済みPhotoの画像viewerが戻る操作で閉じ、開閉でDB fingerprintを変えないこと
- タグ/グループ作成、同名子タグ、タグ名称変更、グループ名称変更、タグの別グループ移動、削除
