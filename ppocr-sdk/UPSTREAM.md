...
The SDK implementation source is retained from that revision. Comparison-only benchmark fixtures and tile assets are intentionally not packaged. The local Gradle build file contains project-integration changes for this repository's plugin/version catalog, SDK levels, and the 16 KB-compatible OpenCV AAR described below. App-facing adapters and feature integration live outside this module.
